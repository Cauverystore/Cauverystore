...
const Pagination = ({ page, totalPages, onPage }) => {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", justifyContent: "center", marginTop: "1.5rem" }}>
      ...
      <input value={goTo} onChange={(e) => setGoTo(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleGoTo()} placeholder="Go" style={{ width: "50px", padding: "0.3rem", fontSize: "0.85rem", border: "1px solid #ccc", borderRadius: "4px", textAlign: "center" }} />
